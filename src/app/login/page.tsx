  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-purple-50 to-pink-50 px-4">
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="bg-white p-8 rounded-2xl shadow-2xl transition-shadow hover:shadow-3xl border border-purple-100">
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 rounded-lg px-4 py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-60 transition-all shadow-lg hover:shadow-xl"
            >
            ...
            <button
              ...
              disabled={!!loadingProvider}
              className="w-full flex items-center justify-center gap-3 bg-gray-900 border border-gray-900 rounded-lg px-4 py-3 text-sm font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 disabled:opacity-60 transition-all shadow-lg hover:shadow-xl"
            >
          ...
          <div className="text-center pt-4 border-t border-gray-200 mt-6">
            <a href="/about" className="text-sm text-purple-600 hover:text-purple-500 font-medium underline">
                Sobre la creadora
            </a>
          </div>
        </div>
